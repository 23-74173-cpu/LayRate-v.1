...
@if($team)
{{-- Add User Modal --}}
<div id="addUserModal" data-modal  data-close="closeAddUserModal" class="hidden fixed inset-0 z-50 min-h-screen min-h-[100dvh] items-center justify-center p-4" role="dialog" aria-modal="true">
...
{{-- Edit User Modal --}}
<div id="editUserModal" data-modal  data-close="closeEditUserModal" class="hidden fixed inset-0 z-50 min-h-screen min-h-[100dvh] items-center justify-center p-4" role="dialog" aria-modal="true">
