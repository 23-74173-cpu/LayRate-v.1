<turbo-frame id="dashboard-stats">
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 mb-3">
        ...
        <div class="kpi-card dash-rise relative overflow-hidden rounded-2xl border bg-white p-5 cursor-pointer"
            ...
            <div class="relative">
                <div class="text-xs font-semibold tracking-[0.125px] uppercase" style="color: #6B7280;">Total Hens</div>
        ...
        <div class="kpi-card dash-rise relative overflow-hidden rounded-2xl border bg-white p-5 cursor-pointer"
            ...
            <div class="relative">
                <div class="text-xs font-semibold tracking-[0.125px] uppercase" style="color: #6B7280;">Today's HDEP</div>
        ...
        <div class="kpi-card dash-rise relative overflow-hidden rounded-2xl border bg-white p-5 cursor-pointer"
            ...
            <div class="relative">
                <div class="text-xs font-semibold tracking-[0.125px] uppercase" style="color: #6B7280;">Eggs Today</div>
        ...
        <div class="kpi-card dash-rise relative overflow-hidden rounded-2xl border bg-white p-5 cursor-pointer"
            ...
            <div class="relative">
                <div class="text-xs font-semibold tracking-[0.125px] uppercase" style="color: #6B7280;">Lifetime Eggs</div>
        ...
        <div class="kpi-card dash-rise relative overflow-hidden rounded-2xl border bg-white p-5 cursor-pointer"
            ...
            <div class="relative">
                <div class="text-xs font-semibold tracking-[0.125px] uppercase" style="color: #6B7280;">Coop Environment</div>
