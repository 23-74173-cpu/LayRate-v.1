<turbo-frame id="dashboard-stats">
    <style>
        ...
        .kpi-value {
            ...
            color: transparent;
            text-shadow: 0 1px 2px rgba(16,42,76,0.12);
        }
    </style>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3">
                ...
                <div class="kpi-card dash-rise relative overflow-hidden rounded-2xl border p-3 cursor-pointer"
                    ...
                    <div class="relative mt-2">
                        ...
                        <div class="text-5xl font-bold leading-none tracking-[-1px] mt-2 kpi-count kpi-value" style="background-image: linear-gradient(135deg,#16a34a,#2D7D46);" data-target="{{ $totalHens }}">0</div>
                    </div>
                ...
                <div class="kpi-card dash-rise relative overflow-hidden rounded-2xl border p-3 cursor-pointer"
                    ...
                    <div class="relative mt-2">
                        ...
                        <div class="text-5xl font-bold leading-none tracking-[-1px] mt-2 kpi-value" style="background-image: linear-gradient(135deg,#0075de,#1D4E8F);">
                ...
                <div class="kpi-card dash-rise relative overflow-hidden rounded-2xl border p-3 cursor-pointer"
                    ...
                    <div class="relative mt-2">
                        ...
                        <div class="text-5xl font-bold leading-none tracking-[-1px] mt-2 kpi-count kpi-value" style="background-image: linear-gradient(135deg,#d97706,#C2703E);" data-target="{{ $eggsToday }}">0</div>
                        <div class="text-xs font-medium mt-1.5 inline-flex items-center gap-1 rounded-full px-2 py-0.5"
                ...
                <div class="kpi-card dash-rise relative overflow-hidden rounded-2xl border p-3 cursor-pointer"
                    ...
                    <div class="relative mt-2">
                        ...
                        <div class="text-5xl font-bold leading-none tracking-[-1px] mt-2 kpi-count kpi-value" style="background-image: linear-gradient(135deg,#8B5CF6,#6B4C8A);" data-target="{{ $lifetimeEggs }}">0</div>
                        <div class="text-xs font-medium mt-1.5 inline-flex items-center gap-1 rounded-full px-2 py-0.5"
            ...
            <div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                ...
                <div class="kpi-card dash-rise relative overflow-hidden rounded-2xl border p-3 cursor-pointer"
                    ...
                    <div class="relative mt-2">
                        ...
                        <div class="text-5xl font-bold leading-none tracking-[-1px] mt-2 kpi-value" style="background-image: linear-gradient(135deg,#f59e0b,#C2703E);">
                ...
                <div class="kpi-card dash-rise relative overflow-hidden rounded-2xl border p-3 cursor-pointer"
                    ...
                    <div class="relative mt-2">
                        ...
                        <div class="text-5xl font-bold leading-none tracking-[-1px] mt-2 kpi-value" style="background-image: linear-gradient(135deg,#0d9488,#2C7C91);">
                ...
                <div class="kpi-card dash-rise relative overflow-hidden rounded-2xl border p-3 cursor-pointer col-span-2 sm:col-span-1"
                    ...
                    <div class="relative mt-2">
                        ...
                        <div class="text-5xl font-bold leading-none tracking-[-1px] mt-2 {{ $mortalityTodayTotal > 0 ? 'kpi-value' : 'text-[#102A4C]' }}" style="{{ $mortalityTodayTotal > 0 ? 'background-image: linear-gradient(135deg,#dc2626,#9b1c24);' : '' }}">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3">
                ...
                <div class="kpi-card dash-rise relative overflow-hidden rounded-2xl border p-3 cursor-pointer"
                    ...
                    <div class="relative mt-2">
                        ...
                        <div class="text-5xl font-bold leading-none tracking-[-1px] mt-2 kpi-value" style="background-image: linear-gradient(135deg,#16a34a,#15803d);">{{ number_format($avgCp, 1) }}%</div>
                    </div>
                ...
                <div class="kpi-card dash-rise relative overflow-hidden rounded-2xl border p-3 cursor-pointer"
                    ...
                    <div class="relative mt-2">
                        ...
                        <div class="text-5xl font-bold leading-none tracking-[-1px] mt-2 kpi-count kpi-value" style="background-image: linear-gradient(135deg,#16a34a,#15803d);" data-target="{{ $avgFeedPerCage }}" data-decimals="1">0</div>
                    </div>
                    <span class="kpi-accent" style="background-color: #e6f6ee;"></span>
                </div>
                ...
                <div class="kpi-card dash-rise relative overflow-hidden rounded-2xl border p-3 cursor-pointer"
                    ...
                    <div class="relative mt-2">
                        ...
                        <div class="text-5xl font-bold leading-none tracking-[-1px] mt-2 kpi-count kpi-value" style="background-image: linear-gradient(135deg,#16a34a,#15803d);" data-target="{{ round($totalFeedWeek, 1) }}" data-decimals="1">0</div>
                        <div class="text-xs font-medium mt-1.5 inline-flex items-center gap-1 rounded-full px-2 py-0.5"
                             style="color: #0f7a44; background-color: rgba(255,255,255,0.78); border: 1px solid rgba(31,138,79,0.35);">
                ...
                <div class="kpi-card dash-rise relative overflow-hidden rounded-2xl border p-3 cursor-pointer"
                    ...
                    <div class="relative mt-2">
                        ...
                        <div class="text-5xl font-bold leading-none tracking-[-1px] mt-2 kpi-value" style="background-image: linear-gradient(135deg,#16a34a,#15803d);">
