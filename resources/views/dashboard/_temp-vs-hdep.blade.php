    ...
    <div class="bg-white rounded-2xl border border-[#e6e6e6] p-3 h-full flex flex-col">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-2">
            <div class="flex items-start gap-3">
                ...
                <div>
                    <div class="text-xs font-semibold tracking-[0.125px] uppercase text-[#6B7280]">Temperature vs HDEP</div>
            ...
            @include('dashboard._days-filter', ['days' => $days, 'frameId' => 'dashboard-temp-vs-hdep', 'routeName' => 'dashboard.temp-vs-hdep'])
        </div>
