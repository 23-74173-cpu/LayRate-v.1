    ...
    <div class="bg-white rounded-2xl border border-[#e6e6e6] p-5 h-full flex flex-col">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4">
            <div class="flex items-start gap-3">
                ...
                <div>
                    <div class="text-sm font-semibold tracking-[0.125px] uppercase text-[#6B7280]">Eggs Collected by Time</div>
                    <div class="text-xs mt-0.5" style="color: #9CA3AF;">{{ number_format($chartData['total']) }} eggs across 7 days</div>
                </div>
            </div>
        </div>
