...
<title>Temporarily Unavailable · LayRate</title>
...
<style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .icon { width: 4rem; height: 4rem; margin: 0 auto 1rem; border-radius: 9999px; background: #e0f2fe; display: flex; align-items: center; justify-content: center; }
...
<body>
    <div class="card">
        <div class="icon">
            <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#0075de" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20h.01"/><path d="M8.5 16.4a5 5 0 0 1 7 0"/><path d="M2 8.82a15 15 0 0 1 20 0"/><path d="M5 12.859a10 10 0 0 1 14 0"/></svg>
        </div>
        <p class="eyebrow">Error 503</p>
        <h1>Temporarily Unavailable</h1>
        <p>The system is briefly down for maintenance or is catching up. Wait a moment, then try again — no action is needed on your part.</p>
