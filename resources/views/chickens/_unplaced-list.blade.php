<div id="unplacedCard" class="bg-white rounded-lg border border-[#D9D9D9] overflow-hidden">
    ...
    <div class="overflow-x-auto hidden" id="unplacedList">
    ...
    function toggleUnplaced() {
        ...
        var chevron = document.getElementById('unplacedChevron');
        var pagination = document.getElementById('unplacedPagination');
        if (!list) return;
    ...
    window.toggleUnplaced = toggleUnplaced;
