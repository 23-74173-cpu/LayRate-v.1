<div id="cullModal" data-modal  data-modal-destructive data-close="closeCullModal" class="hidden fixed inset-0 z-50 min-h-screen min-h-[100dvh] items-center justify-center p-4" role="dialog" aria-modal="true">
